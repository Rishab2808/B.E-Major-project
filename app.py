...
st.set_page_config(page_title='DRS', page_icon='👨‍⚕️',layout = 'wide')
...
st.markdown('<p class="big-font"> • <a href = "https://www.mayoclinic.org/diseases-conditions/high-blood-pressure/symptoms-causes/syc-20373410">High Blood Pressure</a></li><ul></p>', unsafe_allow_html=True)
st.markdown('<p class="big-font"> • <a href = "https://medlineplus.gov/birthcontrol.html">Birth Control</a></li><ul></p>', unsafe_allow_html=True)
...
st.markdown('<p class="big-font">• <a href = "https://www.mayoclinic.org/diseases-conditions/pneumonia/symptoms-causes/syc-20354204">Pneumonia</a></li><ul></p>', unsafe_allow_html=True)
